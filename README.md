...
| partyId <br> matchSecret <br> joinSecret <br> spectateSecret | Strange stuff for create buttons with party, but they are not usable, you can't use this with custom buttons |
